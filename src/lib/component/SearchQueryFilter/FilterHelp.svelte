  ...
  const examples = [
    {
      ...
      items: [
        ...
        { query: "clicked:>365 -tag:important", description: "Old unimportant bookmarks (1+ year)" },
    ...
    <article>
      ...
      <div class="filter-help-content">
        ...
        <div class="tips-section">
          ...
          <ul>
            <li><strong>Cleanup:</strong> <code>clicked:=0 added:&gt;90</code> finds old unused bookmarks</li>
            <li><strong>Device context:</strong> <code>device:mobile +work</code> for mobile work bookmarks</li>
            <li><strong>Time ranges:</strong> Use <code>&gt;</code>, <code>&lt;</code>, <code>=</code> with numbers (days)</li>
            <li><strong>Tag exclusion:</strong> <code>-tag:archived</code> excludes archived items</li>
            <li><strong>Combine filters:</strong> <code>clicked:&gt;365 -tag:important</code></li>
            <li><strong>Quick cleanup:</strong> <code>added:&gt;365 clicked:=0</code> for year-old unused bookmarks</li>
          </ul>
        </div>
      </div>
    </article>
