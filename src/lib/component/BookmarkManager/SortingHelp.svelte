...
<script lang="ts">
  ...
  import { explainRelevanceScore, analyzeRelevanceDistribution, DEFAULT_RELEVANCE_CONFIG } from '$lib/utils/RelevanceUtils';
    ...
    <article>
      ...
      <div class="sorting-help-content">
        <section class="overview-section">
          ...
          <p>
            Smart Usage sorts your bookmarks by <strong>relevance based on your actual usage patterns</strong>, 
            with built-in time decay to ensure frequently used bookmarks rise to the top while stale 
            bookmarks naturally fall down the list as your behavior changes.
          </p>
        </section>
        ...
        <section class="algorithm-section">
          ...
          <div class="formula-explanation">
            ...
            <div class="sub-formulas">
              ...
              <div><strong>Recency Score:</strong> Exponential decay based on time since last visit</div>
            </div>
          </div>
        ...
        <section class="tips-section">
          <h4>Pro Tips</h4>
          <ul>
            <li><strong>Default Choice:</strong> Smart Usage is now the default sort - perfect for daily use</li>
            <li><strong>Combine with Search:</strong> Use search filters to find specific bookmarks, then let Smart Usage prioritize results</li>
            <li><strong>Regular Cleanup:</strong> Use filters like <code>clicked:=0 added:>90</code> to find candidates for removal</li>
            <li><strong>Track Patterns:</strong> Watch how your most-used bookmarks change over time</li>
            <li><strong>New Bookmarks:</strong> Recently added bookmarks get a 7-day boost to encourage trial use</li>
          </ul>
        </section>
      </div>
    </article>
